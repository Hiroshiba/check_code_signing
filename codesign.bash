...
mv eSigner_CKA_*/*.exe eSigner_CKA_Installer.exe
./eSigner_CKA_Installer.exe /CURRENTUSER /VERYSILENT /SUPPRESSMSGBOXES >/dev/null 2>&1
rm -r eSigner_CKA_* eSigner_CKA_Installer.exe
